...
import { Container, Center, CircleOne, CircleTwo, Divider, Box, Title, Input, Subtitle, Button } from './Styled'
            ...
            <Center>
                ...
                <Divider ref={box3}>
                    <Box>
                        ...
                        <Subtitle>Don't have an account? <span><Link to='/signup' className="nodeco">Create one.</Link></span></Subtitle>
